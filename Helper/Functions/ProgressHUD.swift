...
//  Alatraf
//
//  Created by ALY on 24/12/2020.
//  Copyright © 2020 ALATRAF. All rights reserved.
//
...
public extension ProgressHUD {
    ...
    // MARK: -
    //---------------------------------------------------------------------------------------------------------------------------------------------
    class func showSuccess(_ status: String? = nil, image: UIImage? = nil, interaction: Bool = true, completed:@escaping (Bool)->()) {

        DispatchQueue.main.async {
            shared.completedSetup(status: status, staticImage: image ?? shared.imageSuccess, hide: true, interaction: interaction){ done in
...
public class ProgressHUD: UIView {
    ...
    private func setup(status: String? = nil, progress: CGFloat? = nil, animatedIcon: AnimatedIcon? = nil, staticImage: UIImage? = nil, hide: Bool, interaction: Bool) {
        ...
        if (hide) {
            ...
            let delay = Double(text.count) * 0.03 + 2
    ...
    private func completedSetup(status: String? = nil, progress: CGFloat? = nil, animatedIcon: AnimatedIcon? = nil, staticImage: UIImage? = nil, hide: Bool, interaction: Bool, completed:@escaping (Bool)->()) {
